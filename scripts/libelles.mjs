...
const LIBELLES_FR = {
  ...
  'tuile.scanning': 'Sécurité et qualité',
  'tuile.scanning.dont': 'dont {graves} graves · {erreurs} en erreur',
  'tuile.scanning.aucune': { one: 'aucune sur {n} dépôt analysé', other: 'aucune sur {n} dépôts analysés' },
  'tuile.scanning.illisibles': { one: 'illisible sur {n} dépôt — PARC_TOKEN sans le droit « Code scanning »', other: 'illisibles sur {n} dépôts — PARC_TOKEN sans le droit « Code scanning »' },
  ...
  'changements.scanning': 'sécurité et qualité : ',
  'changements.scanning.suite': '{de} → {a}',
  ...
  'carte.scanning.badge': '⛨ {n}',
  'carte.scanning.titre': { one: '{n} alerte sécurité et qualité', other: '{n} alertes sécurité et qualité' },
  'carte.scanning.graves': { one: ', dont {n} grave', other: ', dont {n} graves' },
  'carte.scanning.erreurs': { one: ' · {n} en erreur', other: ' · {n} en erreur' },
  'carte.scanning.lien': 'Voir sur GitHub',
  ...
  'afaire.scanning': { one: '{n} dépôt a des alertes sécurité et qualité', other: '{n} dépôts ont des alertes sécurité et qualité' },
...
const LIBELLES_EN = {
  ...
  'tuile.scanning': 'Security and quality',
  'tuile.scanning.dont': 'of which {graves} severe · {erreurs} errors',
  'tuile.scanning.aucune': { one: 'none across {n} repository analysed', other: 'none across {n} repositories analysed' },
  'tuile.scanning.illisibles': { one: 'unreadable on {n} repository — PARC_TOKEN without the “Code scanning” scope', other: 'unreadable on {n} repositories — PARC_TOKEN without the “Code scanning” scope' },
  ...
  'changements.alertes.suite': '{de} → {a}',
  'changements.scanning': 'security and quality: ',
  'changements.scanning.suite': '{de} → {a}',
  ...
  'carte.scanning.badge': '⛨ {n}',
  'carte.scanning.titre': { one: '{n} security and quality alert', other: '{n} security and quality alerts' },
  'carte.scanning.graves': { one: ', of which {n} severe', other: ', of which {n} severe' },
  'carte.scanning.erreurs': { one: ' · {n} error', other: ' · {n} errors' },
  'carte.scanning.lien': 'View on GitHub',
  ...
  'afaire.scanning': { one: '{n} repository has security and quality alerts', other: '{n} repositories have security and quality alerts' },
